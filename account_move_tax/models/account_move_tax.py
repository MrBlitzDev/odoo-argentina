                ...
                for invoice_line in self.invoice_line_ids:
                    if invoice_line.tax_ids:
                        for tax in invoice_line.tax_ids.ids:
                            ...
                            if account_tax.tax_group_id.tax_type == 'vat' or account_tax.tax_group_id.tax_type == '-vat':
...
class AccountTaxGroup(models.Model):
        ...
        tax_type = fields.Selection(selection=[('vat','IVA'),('-vat', 'IVA Reintegro Turismo'),('withholdings','Percepciones/Retenciones'),('exempt','Exentos')],string='Tipo de Impuestos')